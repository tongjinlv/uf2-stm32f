...
$(UF2): $(FL_OBJS) $(BINARY)
	python3.5 uf2/utils/uf2conv.py --carray $(BINARY) -o $(BUILD_DIR)/bootloader.c
	...
	python3.5 uf2/utils/uf2conv.py -c -f 0x57755a57 -b 0x08010000 $(BUILD_DIR)/flasher.bin -o $(BUILD_DIR)/flasher.uf2
	...
	python3.5 uf2/utils/uf2conv.py -c -f 0x57755a57 -b 0x08008000 $(BUILD_DIR)/flasher16.bin -o $(BUILD_DIR)/flasher16.uf2
